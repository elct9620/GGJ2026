...
| BS-07   | 玩家在食材 100px 範圍內      | 食材飛向玩家    | 食材以 300 px/s 飛向玩家，接觸後攤位 +1 |
| BS-08   | 玩家在食材 100px 範圍外      | 無效果          | 食材保持在原位         |
...
| Test ID | Input                                 | Expected Output              | Accept Criteria          |
| ------- | ------------------------------------- | ---------------------------- | ------------------------ |
| PL-10   | 玩家 (500, 500) + 食材 (500, 500)     | 食材飛向玩家，接觸後攤位 +1 | 距離 < 100px，自動吸取   |
| PL-11   | 玩家中心 (500, 500) + 敵人 (512, 500) | 無碰撞                       | 距離 > 24，無效果        |
| PL-12   | 玩家中心 (500, 500) + 敵人 (510, 500) | 無碰撞（穿透）               | 玩家不受傷               |
| PL-13   | 碰撞箱測試                            | 24×24 px                     | 碰撞箱大小正確           |
| PL-14   | 玩家 (500, 500) + 食材 (650, 500)     | 無效果                       | 距離 > 100px，食材不移動 |

### 2.6.3 Health

| Test ID | Input                 | Expected Output  | Accept Criteria  |
| ------- | --------------------- | ---------------- | ---------------- |
| PL-15   | 生命 5 + 敵人到達底線 | 生命 4           | 扣 1 條生命      |
| PL-16   | 生命 1 + 敵人到達底線 | 生命 0，遊戲結束 | 觸發遊戲結束畫面 |
| PL-17   | 遊戲結束畫面          | 顯示存活回合數   | 統計資訊正確     |
