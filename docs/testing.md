...
| BS-07   | 擊殺敵人                     | 食材立即加入攤位 | 攤位 +1               |
| BS-08   | 擊殺敵人（攤位已滿 6/6）     | 食材無法收集    | 攤位仍為 6/6，食材消失 |
...
| CS-03   | 子彈擊中餓鬼（1 HP）  | 餓鬼死亡，攤位 +1      | 餓鬼消失，食材立即加入攤位 |
...
| EN-02   | 餓鬼 1 HP + 普通子彈擊中 | 餓鬼死亡，攤位 +1       | 餓鬼消失，食材立即加入攤位 |
| EN-03   | 餓鬼死亡                 | 隨機攤位 +1             | 珍珠/豆腐/米血攤位其一增加 |
| EN-04   | 餓鬼到達 x = 384         | 玩家生命 -1，餓鬼消失   | 到達底線               |

### 2.7.2 Boss (餓死鬼)

| Test ID | Input                    | Expected Output         | Accept Criteria         |
| ------- | ------------------------ | ----------------------- | ----------------------- |
| EN-05   | Boss (1000, 500) + 1 秒  | Boss (970, 500)         | 向左移動 30 px          |
| EN-06   | Boss 3 HP + 普通子彈擊中 | Boss 2 HP               | 扣 1 HP                 |
| EN-07   | Boss 3 HP + 3 發普通子彈 | Boss 死亡，攤位 +1      | 3 次攻擊擊殺，食材立即加入攤位 |
| EN-08   | Boss 到達 x = 384        | 玩家生命 -1，Boss 消失  | 到達底線                |
| EN-09   | Boss 死亡                | 隨機攤位 +1             | 珍珠/豆腐/米血攤位其一增加 |

### 2.7.3 Booth Interaction

| Test ID | Input               | Expected Output  | Accept Criteria |
| ------- | ------------------- | ---------------- | --------------- |
| EN-10   | 攤位 3/6 + 敵人觸碰 | 攤位 2/6         | 偷取 1 個食材   |
| EN-11   | 敵人偷取後          | 敵人繼續向左移動 | 不停留在攤位    |
| EN-12   | 攤位 0/6 + 敵人觸碰 | 攤位 0/6         | 無食材可偷      |
...
| ------- | ---------------------- | ----------------------------------------------------- | ---------------- | ----------------------- |
| IT-01   | 完整回合               | 1. 擊敗所有敵人（食材自動收集）<br>2. 選擇升級         | 進入第 2 回合    | 回合數 +1               |
...
| ------- | --------------------- | ------------------------------------------------------------------------- | -------------------- | ------------------------ |
| AT-01   | 新手玩家第一次遊玩    | 1. 按 Space 射擊餓鬼<br>2. 擊殺敵人獲得珍珠<br>3. 合成珍珠奶茶<br>4. 發射散射子彈 | 特殊子彈擊中多隻敵人 | 遊戲機制直觀易懂         |
