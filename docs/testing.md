...
- v0.3.0 (2026-01-31): 更新子彈類型測試案例（§ 2.2.3, § 2.3.1）
...
| ------- | ---- | ---- | ---- | --------------- | ------------- | ------------------------------------------------------------------------------- |
| SY-01   | 3    | 0    | 0    | 火力強化        | 2s            | 基礎傷害 ×8                                                                     |
| SY-02   | 0    | 3    | 0    | 火力強化        | 2s            | 基礎傷害 ×8                                                                     |
| SY-03   | 0    | 0    | 3    | 火力強化        | 2s            | 基礎傷害 ×8                                                                     |
| SY-04   | 2    | 1    | 0    | 珍珠奶茶        | 2s            | 散射                                                                            |
| SY-05   | 1    | 2    | 0    | 臭豆腐          | 2s            | 貫穿                                                                            |
| SY-06   | 2    | 0    | 1    | 珍珠奶茶        | 2s            | 散射                                                                            |
| SY-07   | 1    | 0    | 2    | 豬血糕          | 2s            | 追蹤彈                                                                          |
| SY-08   | 0    | 2    | 1    | 臭豆腐          | 2s            | 貫穿                                                                            |
| SY-09   | 0    | 1    | 2    | 豬血糕          | 2s            | 追蹤彈                                                                          |
| SY-10   | 1    | 1    | 1    | 夜市總匯        | 2s            | 發射閃電追蹤子彈，打到敵人後自動找下一位敵人攻擊，子彈在螢幕外消失，基礎傷害 ×10 |
...
| IT-02   | 合成 → 射擊流程        | 1. 按 2, 2, 2 提取豆腐<br>2. 自動合成<br>3. 按 Space  | 發射火力強化子彈（傷害 ×8）  | 火力強化 Buff 生效        |
| IT-03   | 升級 → 效果生效        | 1. 選擇「加辣」<br>2. 下回合合成臭豆腐<br>3. 射擊敵人 | 貫穿效果 + 升級加成      | 升級效果永久套用        |
...
| AT-03   | Boss 回合使用夜市總匯 | 1. 第 5 回合開始<br>2. 合成夜市總匯<br>3. 射擊 Boss                       | 閃電連鎖擊中所有敵人（傷害 ×10） | 夜市總匯效果正確         |
