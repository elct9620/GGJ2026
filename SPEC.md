...
> **變更記錄**:
>
> - v0.3.0 (2026-01-31): 更新子彈類型與合成配方（§ 2.3.3, § 2.6.3）
...
| 子彈名稱 | 傷害倍率 | 貫穿 | 散射 | 追蹤 | 連鎖 | 說明                                       |
| -------- | -------- | ---- | ---- | ---- | ---- | ------------------------------------------ |
| 普通     | ×1       | 否   | 否   | 否   | 否   | 基礎子彈                                   |
| 火力強化 | ×8       | 否   | 否   | 否   | 否   | 任意同類型 ×3 合成，高傷害                 |
| 臭豆腐   | ×1       | 是   | 否   | 否   | 否   | 豆腐 ×2 + 任意 ×1，貫穿敵人                |
| 珍珠奶茶 | ×1       | 否   | 是   | 否   | 否   | 珍珠 ×2 + 任意 ×1，散射多個子彈            |
| 豬血糕   | ×1       | 否   | 否   | 是   | 否   | 米血 ×2 + 任意 ×1，追蹤敵人                |
| 夜市總匯 | ×10      | 否   | 否   | 是   | 是   | 豆腐 + 珍珠 + 米血各 ×1，閃電連鎖追蹤子彈 |
