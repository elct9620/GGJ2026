...
| ---- | -------- | -------------------- | ------------------------------------- | -------------------------- | ---- |
| 預設 | 普通     | 無                   | 1                                     | 無                         | 無   |
| 1    | 蚵仔煎   | 20 擊殺數            | Boss:10% HP, 菁英:50% HP, 小怪:70% HP | 百分比傷害                 | 單發 |
| 2    | 臭豆腐   | 豆腐×3               | 2                                     | 貫穿 1 敵人                | 2s   |
| 3    | 珍珠奶茶 | 珍珠×3               | 1                                     | 三向散射，+1 子彈          | 2s   |
| 4    | 豬血糕   | 米血×3               | 2                                     | 追蹤，命中-10%敵人移速     | 2s   |
| 5    | 夜市總匯 | 豆腐×1,珍珠×1,米血×1 | 2                                     | 連鎖 5 目標，-20%/命中衰減 | 2s   |
...
| ------ | ---- | ---- | ---- | ---- | ---- | ------------ |
| 任何   | 任何 | 任何 | ≥20  | 無   | 1    | 蚵仔煎成功   |
| 任何   | 任何 | 任何 | <20  | 無   | 1    | 失敗，提示   |
...
| 餓瘋鬼 | Boss        | Boss     | 10      | 0.3  | 特殊升級 | 斜走 | round(6 + (W-5) × 1.0)  |
| 餓幼鬼 | Boss        | Boss     | 6       | 0.7  | 特殊升級 | 直走 | -                       |

**HP 成長範例表**:

| 波次 (W) | 餓鬼 | 彩色餓鬼 | 餓死鬼 | 餓瘋鬼 |
| -------- | ---- | -------- | ------ | ------ |
| 1        | 1    | 2        | -      | -      |
| 5        | 1    | 4        | 10     | 6      |
| 10       | 1    | 7        | 18     | 11     |
