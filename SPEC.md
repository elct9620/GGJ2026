...
- 「任意同類型 ×3」表示珍珠 ×3、豆腐 ×3 或米血 ×3
- 「任意 ×1」表示可為珍珠、豆腐或米血任一種（可與主要食材相同）
- 配方匹配按優先順序：夜市總匯 > 火力強化 > 臭豆腐/珍珠奶茶/豬血糕

| 子彈名稱 | 配方                      | 效果                                                                                               | 持續時間 |
| -------- | ------------------------- | -------------------------------------------------------------------------------------------------- | -------- |
| 普通     | 無（按 Space 直接發動）   | 無                                                                                                 | 無       |
| 火力強化 | 任意同類型 ×3             | 基礎傷害 ×8                                                                                        | 2s       |
| 臭豆腐   | 豆腐 ×2、任意 ×1          | 貫穿                                                                                               | 2s       |
| 珍珠奶茶 | 珍珠 ×2、任意 ×1          | 散射                                                                                               | 2s       |
| 豬血糕   | 米血 ×2、任意 ×1          | 追蹤彈                                                                                             | 2s       |
| 夜市總匯 | 豆腐 ×1、珍珠 ×1、米血 ×1 | 發射像閃電一樣的追蹤子彈，在打到敵人後會自動去找下一位敵人並攻擊，子彈會在螢幕外消失，基礎傷害 ×10 | 2s       |
