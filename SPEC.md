...
- **誇張化（Exaggeration）**: 視覺尺寸大於實際判定範圍 1.5~2 倍
...
- 持續時間：2s Buff
- 碰撞箱：10×10 px（每顆）
- **視覺尺寸**: 32×32 px（碰撞箱的 3.2 倍，圓潤巨大黑珍珠）
...
- 消耗：20 擊殺數（單發）
- 碰撞箱：32×32 px
- **視覺尺寸**: 128×128 px（碰撞箱的 4 倍，巨大投擲物）
...
| 視覺誇張倍率 | 視覺尺寸 = 判定尺寸 × 1.5~16x                | 所有子彈       |
| 尾跡長度 | 普通 32px，特殊 48~96px，終極 160px          | 所有子彈       |
