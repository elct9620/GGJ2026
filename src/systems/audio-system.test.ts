...
describe("AudioSystem", () => {
  ...
  describe("Sound Playback", () => {
    ...
    it("應該播放子彈發射音效當 BulletFired 事件發布時", () => {
    ...
    it("應該播放敵人被擊中音效當 EnemyHit 事件發布時", () => {
    ...
    it("應該播放按鈕點擊音效當 ButtonClicked 事件發布時", () => {
  ...
  describe("Lifecycle", () => {
    it("應該清理所有資源當 destroy 被呼叫時", async () => {
      await new Promise((resolve) => setTimeout(resolve, 50));
    ...
    it("應該暫停所有播放中的音效當 destroy 被呼叫時", async () => {
      await new Promise((resolve) => setTimeout(resolve, 50));
